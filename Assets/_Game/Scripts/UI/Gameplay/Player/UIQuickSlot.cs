...
namespace ZZ
{
    ...
    public class UIQuickSlot : MonoBehaviour
    {
        ...
        [SerializeField] private HUDNumberDisplay m_quantityDisplay;
        ...
        public void SetQuantity(int quantity, bool alwaysShow = false)
        {
            ...
            bool shouldShowQuantity = alwaysShow
                ? quantity >= 0
                : quantity > 1;
            m_quantityDisplay.gameObject.SetActive(shouldShowQuantity);
            m_quantityDisplay.SetNumber(shouldShowQuantity ? quantity : -1);
        }
