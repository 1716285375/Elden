...
namespace ZZ
{
    ...
    public class CharacterUIManager : MonoBehaviour
    {
        ...
        private Camera m_viewingCamera;
        ...
        private void LateUpdate()
        {
            ...
            if (m_viewingCamera == null || !m_viewingCamera.isActiveAndEnabled)
            {
                m_viewingCamera = Camera.main;
            }

            if (m_viewingCamera == null)
            {
                return;
            }
            ...
            canvasTransform.LookAt(
                canvasTransform.position + m_viewingCamera.transform.forward,
                m_viewingCamera.transform.up);
        }
